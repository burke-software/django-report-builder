...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReportDownload'
        db.create_table(u'report_builder_reportdownload', (
        ...
        db.send_create_signal(u'report_builder', ['ReportDownload'])


    def backwards(self, orm):
        # Deleting model 'ReportDownload'
        db.delete_table(u'report_builder_reportdownload')
    ...
    models = {
        ...
        u'report_builder.reportdownload': {
            'Meta': {'object_name': 'ReportDownload'},
