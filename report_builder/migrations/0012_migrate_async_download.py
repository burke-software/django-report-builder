...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for report in orm['report_builder.Report'].objects.exclude(report_file=""):
            if report.reportdownload_set.count() == 0:
                report_download = orm['report_builder.ReportDownload'].objects.create(
                    report=report,
    ...
    models = {
        ...
        u'report_builder.reportdownload': {
            'Meta': {'ordering': "('-finished',)", 'object_name': 'ReportDownload'},
